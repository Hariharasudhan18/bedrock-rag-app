!pip install boto3 faiss-cpu PyPDF2 cohere
...
# Initialize Cohere Client for embedding
cohere_client = CohereClient('your_cohere_api_key')
...
def get_embeddings(text):
    response = cohere_client.embed(texts=[text], model='embed-english-v3')
